 ...
 * 
 * | bpf_cubic directory|  | external projet directory |
 *          |                           |
 *          |                           |
 *          -----------------------------
 *                      |
 ...
 *              | parent directory |
 * 
 ** Then bpfcubic.bpf.o path resolution from {external projet directory} 
 ** has to be -- "../bpf_cubic/.output/bpfcubic.bpf.o"
*/
char *ebpf_cc_binary_path  = "../bpfcubic/.output/bpfcubic.bpf.o";
